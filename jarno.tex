...
\frame{
    ...
    \item Creating a Type-Checker for the MC compiler
    \end{itemize}
}
...
\frame{
    ...
    A parser monad is a abtraction that contains a list of elements and a context inside a maybe monad inside a state monad.
...
\frame{
    ...
    \begin{enumerate}
    \item Identification of function names in definitions
